...
public class MainInsertionRandom2 {
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10000; i++) {
			e = randomGenerator.nextInt(100000);
		...
		// par opération.
		time_analysis.save_values("../plots/binary_heap_time_java_Random2.plot");
		copy_analysis.save_values("../plots/binary_heap_copy_java_Random2.plot");
		memory_analysis.save_values("../plots/binary_heap_memory_java_Random2.plot");
