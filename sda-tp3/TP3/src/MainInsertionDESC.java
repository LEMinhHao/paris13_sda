...
public class MainInsertionDESC {
	public static void main(String[] args) {
		...
		// par opération.
		time_analysis.save_values("../plots/binary_heap_time_java_DESC.plot");
		copy_analysis.save_values("../plots/binary_heap_copy_java_DESC.plot");
		memory_analysis.save_values("../plots/binary_heap_memory_java_DESC.plot");
