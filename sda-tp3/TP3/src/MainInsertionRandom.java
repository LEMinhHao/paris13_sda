...
public class MainInsertionRandom {
	public static void main(String[] args) {
		...
		// par opération.
		time_analysis.save_values("../plots/binary_heap_time_java_Random.plot");
		copy_analysis.save_values("../plots/binary_heap_copy_java_Random.plot");
		memory_analysis.save_values("../plots/binary_heap_memory_java_Random.plot");
