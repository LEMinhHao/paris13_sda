...
public class MainInsertionDeletion {
	public static void main(String[] args) {
		...
		for (int i = 0; i < 100000; i++) {
			...
			if (randomGenerator.nextFloat() < p) {
				...
				if (binomialHeap.size() > 0) {
					...
					after = System.nanoTime();
					isAllocated = binomialHeap.isReduced;
					time_analysis.append(after - before);
		...
		// par opération.
		time_analysis.save_values("../plots/binomial_heap_time_java_INSDEL.plot");
		copy_analysis.save_values("../plots/binomial_heap_copy_java_INSDEL.plot");
		memory_analysis.save_values("../plots/binomial_heap_memory_java_INSDEL.plot");
	}
}
